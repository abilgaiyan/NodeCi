...
describe('When logged in', async () =>{
   ...
   describe('And using valid input', async () =>{
      ...
      test('Submitting then save blog add the blog to index page', async () =>{
...
describe('When not logged in', async () => {
   const actions =[
       ...
       },
       {
        ...
        //    test('Not able to create a new blog post', async () =>{
        //       const url ='/api/blogs';
        //       const body ={title:'My Title', content:'My Content'}; 
        //       const result =  await page.post(url, body);

        //         expect(result).toEqual({"error":"You must log in!"});
        //    })

        //    test('Not able to get a list of blogs', async () =>{
